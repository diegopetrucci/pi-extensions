...
const PROVIDER_MODEL_PREFERENCES: Record<string, string[]> = {
	...
	xiaomi: ["mimo-v2.5-pro-ultraspeed", "mimo-v2.5-pro", "mimo-v2.5"],
	"xiaomi-token-plan-ams": ["mimo-v2.5-pro", "mimo-v2.5"],
	"xiaomi-token-plan-cn": ["mimo-v2.5-pro", "mimo-v2.5"],
	"xiaomi-token-plan-sgp": ["mimo-v2.5-pro", "mimo-v2.5"],
	nvidia: [
		"nvidia/nemotron-3-ultra-550b-a55b",
	...
	moonshotai: ["kimi-k3", "kimi-k2.7-code", "kimi-k2.7-code-highspeed", "kimi-k2.6", "kimi-k2-thinking-turbo", "kimi-k2-thinking", "kimi-k2.5"],
	"moonshotai-cn": ["kimi-k3", "kimi-k2.7-code", "kimi-k2.7-code-highspeed", "kimi-k2.6", "kimi-k2-thinking-turbo", "kimi-k2-thinking", "kimi-k2.5"],
};
