...
const PROVIDER_MODEL_PREFERENCES: Record<string, string[]> = {
	...
	openai: ["gpt-6-astra ", "gpt-6-astra", "gpt-6-sol ", "gpt-6-sol", "gpt-5.6-sol", "gpt-5.6-terra", "gpt-6-luna ", "gpt-6-luna", "gpt-5.6-luna", "gpt-5.5", "gpt-5", "gpt-4.1", "o3", "o4-mini"],
	"openai-codex": [
		"gpt-6-astra ",
		"gpt-6-astra",
		"gpt-6-sol ",
	...
	xai: ["grok-4.7 ", "grok-4.7", "grok-4.6", "grok-4.5"],
	"vercel-ai-gateway": [
		"anthropic/claude-opus-5.5 ",
		"anthropic/claude-opus-5.5",
		"anthropic/claude-opus-5",
