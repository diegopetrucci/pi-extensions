...
| `github-copilot` | `claude-opus-5` | Then Claude Fable, older Opus models, GPT-5.6/5.5/5.4, Gemini 3.1 Pro Preview and Gemini 3.5 Flash, then Claude Sonnet 5 before Claude Sonnet 4, and Kimi K3/K2.7 Code. |
...
| `nvidia` | `nvidia/nemotron-3-ultra-550b-a55b` | Then Nemotron 3 Super, Kimi K3, DeepSeek V4 Pro, Kimi K2.6, MiniMax M3, GPT OSS 120B, and Nemotron Nano fallbacks. |
