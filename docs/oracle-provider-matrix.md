...
| `qwen-token-plan` | `qwen3.8-max-preview` | Then Qwen 3.7/3.6, DeepSeek V4 Pro, GLM 5.2, Kimi K2.7, and MiniMax fallbacks. |
| `qwen-token-plan-cn` | `qwen3.8-max-preview` | Then Qwen 3.7/3.6, DeepSeek V4 Pro, GLM 5.2, Kimi K2.7, and MiniMax fallbacks. |
...
| `xai` | `grok-4.5` | Then Grok 4.3 and current Grok build fallbacks. |
