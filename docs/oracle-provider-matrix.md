...
|---|---|---|
| `amazon-bedrock` | `claude-opus-5` | Falls back through Claude Fable and older Opus IDs, GPT-5.6 Sol/Terra/Luna, Claude Sonnet, and other reasoning models including Grok 4.6. |
...
| `cerebras` | `gpt-oss-120b` | Then Gemma 4 31B. |
| `cloudflare-ai-gateway` | `claude-fable-5` | Then current Claude Opus, GPT-5.x, and Workers AI Kimi K2.7, DeepSeek V4 Pro, GLM 5.3/5.2, Nemotron, and GPT OSS reasoning models. |
...
| `github-copilot` | `claude-opus-5` | Then Claude Fable, older available Opus models, GPT-6 Astra, GPT-5.6/5.5/5.4, Gemini 3.5 Flash, then Claude Sonnet 5 before Claude Sonnet 4, and Kimi K3/K2.7 Code. |
...
| `moonshotai` | `kimi-k3` | Then Kimi K2.7 Code/HighSpeed, K2.6, Thinking Turbo/Thinking, and K2.5. |
| `moonshotai-cn` | `kimi-k3` | Then Kimi K2.7 Code/HighSpeed, K2.6, Thinking Turbo/Thinking, and K2.5. |
| `nvidia` | `nvidia/nemotron-3-ultra-550b-a55b` | Then Nemotron 3 Super, Kimi K3, DeepSeek V4 Pro, Kimi K2.6, MiniMax M3, and Nemotron Nano Omni reasoning. |
| `openai` | `gpt-6-astra` | Then GPT-5.6 Sol/Terra/Luna, current GPT-5 aliases, and o-series reasoning models. |
| `openai-codex` | `gpt-6-astra` | Then GPT-5.6 Sol/Terra/Luna, GPT-5.5/5.4, and current Codex Spark fallback IDs. |
| `opencode` | `claude-opus-5` | Then Claude Fable, GPT-5.5/5.4, older Claude Opus models, Grok 4.5, Gemini 3.5, GLM 5.2/5.1, Kimi K3/K2.7, Qwen, and MiniMax. |
| `opencode-go` | `deepseek-v4-pro` | Then GLM 5.3/5.2/5.1, Qwen 3.7/3.6, MiMo 2.5, MiniMax M3/M2.7, and Kimi K3/K2.7/K2.6. |
| `openrouter` | `anthropic/claude-opus-5` | Then Claude Fable/latest, older Claude Opus models, OpenAI GPT-5.6 Sol/Terra/Luna plus current OpenRouter aliases, Gemini Pro/Gemini 3.5, Kimi K3/latest/K2.7, Grok latest/4.5, DeepSeek, MiniMax M3, and GLM 5.3/5.2. `claude-opus-5` also matches fast-only catalog variants when no base ID is present. |
...
| `vercel-ai-gateway` | `anthropic/claude-opus-5` | Then Claude Fable, older Claude Opus models, Claude Sonnet 5 before Claude Sonnet 4, OpenAI GPT-5.6 Sol/Terra/Luna and Codex IDs, Kimi K3/K2.7, DeepSeek, Qwen 3.7/3.6, Gemini 3.5, xAI Grok 4.5/4.20, MiniMax M3, and GLM 5.3/5.2. `claude-opus-5` also matches fast-only catalog variants when no base ID is present. |
| `xai` | `grok-4.6` | Then Grok 4.5 and Grok 4.3. |
