...
- [x] verify docs exist
  - [x] `docs/release-notes-v0.1.19.md`
  - [x] `docs/github-release-v0.1.19.md`
  - [x] `docs/announcement-v0.1.19.md`
  - [x] `docs/publish-checklist-v0.1.19.md`
...
- [x] create GitHub release for `v0.1.19`
- [x] paste contents of `docs/github-release-v0.1.19.md`
...
- [ ] publish standalone context inspector package

```bash
cd extensions/context-inspector
npm publish
cd ../..
```
...
- [ ] verify npm package pages show expected versions
  - [ ] `@diegopetrucci/pi-extensions@0.1.19`
  - [ ] `@diegopetrucci/pi-context-inspector@0.1.0`
...
- [ ] publish announcement copy from `docs/announcement-v0.1.19.md`
