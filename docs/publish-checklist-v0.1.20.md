...
- [x] verify docs exist
  - [x] `docs/release-notes-v0.1.20.md`
  - [x] `docs/github-release-v0.1.20.md`
  - [x] `docs/announcement-v0.1.20.md`
  - [x] `docs/publish-checklist-v0.1.20.md`
- [x] verify extension files exist
  - [x] `extensions/context-inspector/index.ts`
  - [x] `extensions/context-inspector/README.md`
  - [x] `extensions/librarian/index.ts`
  - [x] `extensions/librarian/README.md`
  - [x] `extensions/quiet-tools/index.ts`
  - [x] `extensions/quiet-tools/README.md`
...
- [x] run quiet-tools bundling sanity check
...
```bash
node - <<'NODE'
// Load the extension with jiti, register /context against a mock pi API,
// run /context --no-open --redact against a mock session, and assert the
// generated HTML exists, is mode 0600, and does not contain seeded secrets.
NODE
```
...
- [x] confirm collection package exposes all nine extensions in root `package.json`
...
- [x] create GitHub release for `v0.1.20`
- [x] paste contents of `docs/github-release-v0.1.20.md`
...
### Updated standalone package

- [ ] publish standalone quiet-tools package

```bash
cd extensions/quiet-tools
npm publish
cd ../..
```
...
- [ ] verify npm package pages show expected versions
  - [ ] `@diegopetrucci/pi-extensions@0.1.20`
  - [ ] `@diegopetrucci/pi-quiet-tools@0.1.1`
...
- [ ] publish announcement copy from `docs/announcement-v0.1.20.md`
