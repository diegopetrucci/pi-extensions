# Publish checklist — v0.1.40

## Preflight

- [x] confirm current branch is `main`
- [x] confirm `v0.1.40` does not exist locally or on GitHub
- [x] verify npm registry state and local versions are unpublished for root `0.1.40` and `git-footer` `0.1.1`
...
- [x] verify docs exist:
  - [x] `docs/release-notes-v0.1.40.md`
  - [x] `docs/github-release-v0.1.40.md`
  - [x] `docs/announcement-v0.1.40.md`
  - [x] `docs/publish-checklist-v0.1.40.md`
...
- [x] root collection package includes updated `git-footer` files and Pi `0.78.0` marker
...
- [x] create tag: `v0.1.40`

```bash
git add .
git commit -m "Prepare v0.1.40 release"
git tag v0.1.40
```
...
- [x] create GitHub release for `v0.1.40`
- [x] paste contents of `docs/github-release-v0.1.40.md`
...
- [ ] publish announcement copy from `docs/announcement-v0.1.40.md`
