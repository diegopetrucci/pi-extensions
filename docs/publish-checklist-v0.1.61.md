# Publish checklist — v0.1.61

## Target package versions

- [x] `@diegopetrucci/pi-agent-workflow-audit@0.1.8`
- [x] `@diegopetrucci/pi-annotate-git-diff@0.1.8`
- [x] `@diegopetrucci/pi-annotate-last-message@0.1.6`
- [x] `@diegopetrucci/pi-brrr@0.1.11`
- [x] `@diegopetrucci/pi-claude-fast@0.1.11`
- [x] `@diegopetrucci/pi-code-reviewer@0.1.6`
- [x] `@diegopetrucci/pi-confirm-destructive@0.1.9`
- [x] `@diegopetrucci/pi-context-cap@0.1.8`
- [x] `@diegopetrucci/pi-context-inspector@0.1.10`
- [x] `@diegopetrucci/pi-contrarian@0.1.8`
- [x] `@diegopetrucci/pi-dirty-repo-guard@0.1.8`
- [x] `@diegopetrucci/pi-git-footer@0.1.7`
- [x] `@diegopetrucci/pi-gnosis@0.1.8`
- [x] `@diegopetrucci/pi-illustrations-to-explain-things@0.1.6`
- [x] `@diegopetrucci/pi-inline-bash@0.1.8`
- [x] `@diegopetrucci/pi-librarian@0.1.13`
- [x] `@diegopetrucci/pi-minimal-footer@0.1.17`
- [x] `@diegopetrucci/pi-notify@0.1.14`
- [x] `@diegopetrucci/pi-openai-fast@0.1.13`
- [x] `@diegopetrucci/pi-oracle@0.1.23`
- [x] `@diegopetrucci/pi-permission-gate@0.1.11`
- [x] `@diegopetrucci/pi-quiet-tools@0.1.9`
- [x] `@diegopetrucci/pi-review@0.1.11`
- [x] `@diegopetrucci/pi-todo@0.1.8`
- [x] `@diegopetrucci/pi-triage-comments@0.1.9`
- [x] `pi-dynamic-context-pruning@0.1.4`
- [x] `@diegopetrucci/pi-extensions@0.1.61`
...
- [x] `npm run ci` passed with 519/519 tests
...
- [x] `npm audit`, `npm audit --omit=dev`, and `npm audit --omit=dev --audit-level=high` were run; each reported the same remaining upstream high-severity finding: `brace-expansion<=5.0.7` nested under published `@earendil-works/pi-coding-agent@0.82.1`
- [x] all 27 `.pi-fleet-tested-version` files read `0.82.1`
...
- [x] `npm pack --dry-run --json` and `npm publish --dry-run --ignore-scripts --access public` passed for the root package plus all 26 standalone targets; aggregate dry-run totals were `packages=27`, `totalFiles=305`, `totalTarballBytes=2435358`, `totalUnpackedBytes=4102034`, `suspiciousTotal=0`, and `publishDryRunFailures=0`
...
- [ ] commit the prepared release changes on `compat/pi-0.82.1` outside tlh
- [ ] push the release branch
- [ ] open a pull request targeting `main`
- [ ] after the pull request merges, tag `v0.1.61` on `main`
- [ ] push tag `v0.1.61`
- [ ] create the GitHub release using `docs/github-release-v0.1.61.md`
