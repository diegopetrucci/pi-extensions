...
- [x] verify docs exist
  - [x] `docs/release-notes-v0.1.17.md`
  - [x] `docs/github-release-v0.1.17.md`
  - [x] `docs/announcement-v0.1.17.md`
  - [x] `docs/publish-checklist-v0.1.17.md`
...
- [x] run quiet-tools renderer smoke test

```bash
export NODE_PATH=/opt/homebrew/lib/node_modules/@earendil-works/pi-coding-agent/node_modules:/opt/homebrew/lib/node_modules
bun --eval '<loads quiet-tools, verifies collapsed one-line output and expanded renderer handoff>'
```
...
- [x] confirm quiet-tools package declares `@earendil-works/pi-coding-agent` and `@earendil-works/pi-tui` peers
...
- [x] create GitHub release for `v0.1.17`
- [x] paste contents of `docs/github-release-v0.1.17.md`
...
- [ ] verify npm package pages show expected versions
  - [ ] `@diegopetrucci/pi-extensions@0.1.17`
  - [ ] `@diegopetrucci/pi-quiet-tools@0.1.0`
...
- [ ] publish announcement copy from `docs/announcement-v0.1.17.md`
