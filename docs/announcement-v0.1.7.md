# Announcement copy — v0.1.7

## Short post

Released `@diegopetrucci/pi-extensions@0.1.7`.
...
Just released `@diegopetrucci/pi-extensions@0.1.7`.
...
Released a small `confirm-destructive` extension for pi.

It asks before destructive session actions like clear, switch, and fork.

`pi install npm:@diegopetrucci/pi-confirm-destructive`

## Discord / forum version

I just shipped `v0.1.7` of my pi extensions package.
